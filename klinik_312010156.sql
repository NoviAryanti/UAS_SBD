...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Jul 2022 pada 18.42
...
(557, 'Novi', '9ec855cbce79cc2bc8730f459f8e3f06', 'Novi Putri Eryanti');
...
--
ALTER TABLE `user`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=558;
